...
class Post(models.Model):
    owner = models.ForeignKey('auth.User', related_name='blog7_posts', on_delete=models.CASCADE)
...
class Comment(models.Model):
    owner = models.ForeignKey('auth.User', related_name='blog7_comments', on_delete=models.CASCADE)
...
class Postlike(models.Model):
    ...
    liked_by = models.ForeignKey('auth.User', related_name='blog7_postlikes', on_delete=models.CASCADE)
...
class PostlikeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'blog7_postlike' # mandatory for drf_yasg
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'blog7_comment' # mandatory for drf_yasg
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'blog7_post' # mandatory for drf_yasg
```
